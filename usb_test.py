...
try:
    ...
    if(args.wValue is not None and args.wValue >= 0 and args.wIndex is not None and args.wIndex >= 0 and args.wLength is not None and args.wLength >= 0 and bmRequestType is not None and and bRequest is not None):
        try:
