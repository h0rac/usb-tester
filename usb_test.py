...
try:
    ...
    if(args.wValue is not None and args.wValue >= 0 and args.wIndex is not None and args.wIndex >= 0 abd args.wLength is not Note and args.wLength >= 0 and bmRequestType is not None and and bRequest is not None):
        try:
